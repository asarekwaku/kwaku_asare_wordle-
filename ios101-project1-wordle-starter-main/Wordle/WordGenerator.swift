...
class WordGenerator {
  ...
  static let possibleWords = ["BREAK", "HOUSE", "GRAPE", "SMILE", "CLOUD", "APPLE", "BRAIN", "ANGEL", "OCEAN", "TIGER","CHAOS", "FLAME", "GLORY", "JUDGE", "LEMON", "NIGHT", "QUIET", "SNAKE", "THORN", "WATER","SNOWY", "PANDA", "RAVEN", "GHOST", "LUNCH", "FAIRY", "VIOLA", "QUICK", "HORSE", "ZEBRA","TULIP", "OASIS", "FLUTE", "BRAVE", "KAYAK", "FUDGE", "CAMEL", "PIXEL", "CROWN", "QUACK", "BLAST", "SMOKE", "WAVES", "FROST", "DREAM", "JELLY", "BONUS", "ZEBRA", "GLOVE", "SPOON"]
